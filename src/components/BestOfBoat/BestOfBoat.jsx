                            ...
                            <div className='pb-1'>
                                ...
                                <div className='flex justify-between px-2 items-center'>
                                    <div className='flex items-center'>
                                        ...
                                        <h1 className='flex items-center font-bold text-[0.875rem] bm:text-[1.1875rem]'>₹1,299</h1>
                                    </div>
                                ...
                                <div className='px-2 flex items-center gap-2'>
                                    <h1 className='line-through text-[0.625rem] text-gray-400 font-semibold font-metropolis'>₹3,499</h1>
                                    <h2 className='text-[0.625rem] text-[#0e946a] font-bold'>60% off</h2>
                                </div>
                            </div>
                        </div>
                </div>
            ...
            <div>
                <div>
                        ...
                        <div className='bg-[#fafafa] rounded-b-lg border border-gray-200 flex flex-col'>
                            {/* boat airdrops 161 */}
                            <div className='flex h-10 bm:h-12 px-2 items-start pt-1 bm:pt-0 bm:items-center border-b-2'>
                                <h1 className='text-[0.75rem] bm:text-[0.9375rem] font-bold font-metropolis'>{company.name} Earbards PB400</h1>
                            </div>
