    ...
    <div className="fixed z-50 top-10 base:top-8 bg-white border border-b-gray-200 w-full px-1 md:px-10 h-14 md:h-20 xl:h-23 flex items-center">
      <div className="my-5 w-full mx-auto flex justify-center items-center">
        <div className="flex flex-row w-full justify-between items-center">
          ...
          {/* xl laptop screen */}
          {/* boat + ul list */}
          <div className="hidden xl:flex justify-between items-center gap-28">
                {/* boat */}
                <div className="">
                    <p>
                      <svg
                ...
                {/* ul list */}
                <div className="">
                    <ul className="flex flex-row items-center gap-10 text-[1rem] font-normal font-metropolis cursor-pointer">
                        ...
                        <li className="hover:text-[15px] hover:font-semibold">boAt Personalisation</li>
                            ...
                            {isMoreHovered && (
                                <div className="absolute px-2 top-full flex flex-col w-[160px] justify-center py-4 bg-white shadow-lg left-[-40px] mt-7 p-2 gap-2">
                                    <ul>
                                        ...
                                        <li className="px-2 text-gray-600 font-metropolis text-[13px] cursor-pointer">boAt Community</li>
                                    </ul>
                                </div>
                            )}
                        </li>
                    ...
                    <div className="absolute border px-4 top-full flex flex-col w-[10%] justify-center py-4 bg-white shadow-lg">
                        ...
                        <h1 className="text-[13px] text-gray-600 font-metropolis">boAt Community</h1>
                    </div>
                    )} */}
                </div>
          </div>
                    ...
                    <div className={`w-[25rem] px-6 absolute bg-white top-full mt-[0.4px] left-0  h-[33.6rem] ${openCategories === true ? "max-h-[90vh] overflow-y-auto" : "h-[33.6rem]"} ${openMore === true ? "max-h-[90vh] overflow-y-auto" : "h-[33.6rem]"}`}>
                        <div className="flex flex-col items-center mt-3 gap-4">
                            ...
                            <div className="h-12 rounded-lg w-full flex justify-between items-center">
                                <h1 className="font-semibold">boAt Personalisation</h1>
